...
namespace StudentOglasi.Services.StateMachines.PrijavePrakseStateMachine
{
    public class DraftPrijavePraksaState : BasePrijavePrakseState
    {
        ...
        public DraftPrijavePraksaState(IServiceProvider serviceProvider, IMailService service, StudentoglasiContext context, IMapper mapper) : base(serviceProvider, context, mapper)
        {
            _service = service;
        }
        public override async Task<Model.PrijavePraksa> Approve(int studentId, int praksaId)
        {
            ...
            var emailObj = new EmailObject
            {
                ...
                poruka = "Vaša prijava na praksu: " + entity.Praksa.IdNavigation.Naslov + " je odobrena/prihvaćena"
            };
